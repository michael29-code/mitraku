                            ...
                            <div class="card mx-2 mb-4">
                                <div class="card-img-top position-relative" style="height: 50%;">
                                    <img src="https://www.hargatiket.net/wp-content/uploads/2018/07/Harga-Tiket-Citra-Raya-Water-World.jpg"
                                        class="img-fluid w-100 h-100" alt="Avatar" style="object-fit: cover;">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge text-bg-primary rounded-pill"
                                            style="font-size: 1.25rem; padding: 0.5em 1em;">Teknologi</span>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            <p>PT. Teknologi Maju Jaya adalah perusahaan teknologi yang berdedikasi untuk
                                                menyediakan solusi terkini dan inovatif dalam bidang teknologi informasi. </p>
                                        </div>
                                    </div>
                                    <hr>
