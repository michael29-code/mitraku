...
@section('content')
    @if ($latestBlog)
    <div class="rectangle mt-4 gmbr-nekobot" style="background-image: url('{{ asset('storage/' . $latestBlog->image) }}'); background-size: cover; background-position: center; display: flex; flex-direction: column; justify-content: center">
