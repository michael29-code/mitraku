                ...
                <div class="d-flex justify-content-center shadow bg-body-tertiary rounded mx-auto p-3" style="width: 100%; max-width: 550px; min-height: 100px;">
                    <div class="text p-4">
                        ...
                        <div class="d-flex justify-content-between">
                            <form action="{{ route('delete-advertisement-admin', $a->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this advertisement?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-xs btn-danger me-2 mx-0">Delete</button>
                            </form>
                            <a href="{{ route('edit-advertisement-admin', ['id' => $a->id]) }}" class="btn btn-xs btn-primary">Edit Advertisement</a>
                        </div>
                    </div>
