            ...
            <div class="row mx-3 my-5 bg-body-tertiary rounded">
                @foreach ($advertisements as $a)
                    <div class="explaination col-lg-6 mb-3">
                        <div class="d-flex justify-content-center shadow bg-body-tertiary rounded mx-auto p-3"
                            style="width: 100%; max-width: 550px; min-height: 100px;">
                            <div class="text p-4">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('edit-advertisement-admin', ['id' => $a->id]) }}"
                                        class="btn btn-xs btn-primary">Edit Advertisement</a>
                                </div>
                            </div>
