                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col mx-2 my-2 py-2 border-bottom d-flex align-items-center">
                                ...
                                <a href="/view-blog" class="text-decoration-none text-black" style="font-size: 20px;">View Blog</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mx-2 my-2 py-2 border-bottom d-flex align-items-center">
                                <i class="fa-solid fa-pen-to-square fs-4 me-3"></i>
                                <a href="/write-blog" class="text-decoration-none text-black" style="font-size: 20px;">Write Blog</a>
                            </div>
                        </div>
                    </div>
                </div>
