            ...
            <div class="card border border-0 position-relative"> {{-- Tambahkan class position-relative --}}
                <div class="card-body-blog pb-5" style="min-height: 450px;"> {{-- Menyesuaikan tinggi kartu --}}
                    <div class="row my-3">
                        <div class="col-5">
                            <div class="row">
                                <div class="col-1 d-flex justify-content-center align-items-center">
                                    <a href="/manage-blog"><i class="fa-solid fa-arrow-left" style="font-size: 2rem"></i></a>
                                </div>
                                <div class="col">
                                    <h4>View Blog</h4>
                                </div>
                        ...
                        <div class="col">
                            <form method="GET" action="{{ route('search-blog-admin') }}" class="d-flex flex-row mb-3" required>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border border-start-0"
                                        aria-label="Text input with checkbox" placeholder="search blog name" name="search">
                                </div>
                        ...
                        <div class="col my-3">
                            <div class="card mx-2 h-100 d-flex flex-column">
                                <a href="/view-blog-detail/{{ $blog->slug }}">
                                    <img src="{{ asset('storage/' . $blog->image) }}" class="card-img-top mx-auto" alt="..." style="max-height: 300px; object-fit: cover;">
                                    <div class="card-body-blog mx-3 d-flex flex-column">
                                        <div>
                                            <span class="badge text-bg-primary my-2">{{ optional($blog->category)->jenisKategori ?? 'Uncategorized' }}</span>
                                            ...
                                            <div class="row my-3 align-items-center">
                                                ...
                                                <div class="col d-flex align-items-center">
                                                    <div class="flex-grow-1"> <!-- Menggunakan flex-grow-1 untuk memperluas area -->
                                        ...
                                        <div class="mt-auto me-3"> {{-- Menggunakan mt-auto untuk menekan tombol delete ke bawah --}}
                                            <form action="/delete-blog/{{ $blog->slug }}" method="post"class="d-inline">
                                                @method('delete')
                                                @csrf
